...
<div class="max-w-3xl mx-auto mt-3 px-1">
    <h2 class="text-lg font-semibold mb-6 text-left"> Adiconar cargo novo</h2>
    ...
    <form action="{{ route('cargo.store') }}" method="POST" novalidate>
        @csrf
        ...
        <div class="border border-gray-300 rounded-md bg-white shadow-sm overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 p-5">
                <div>
                    ...
                    <input id="nome" name="nome" type="text"
                           ...
                           value="{{ old('nome') }}" placeholder="Ex.: Analista de RH" required>
            ...
            <div class="p-5">
                ...
                <textarea id="descricao" name="descricao" rows="3"
                          ...
                          placeholder="Breve descrição das funções do cargo" required>{{ old('descricao') }}</textarea>
